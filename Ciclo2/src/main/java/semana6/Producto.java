...
public class Producto {
    ...
    public boolean modificar_producto()
    {
        ...
        try{
            ...
            String strActualizar = "UPDATE tienda.producto set nombre=?, valor=? where id=?";
        ...
        public boolean eliminar_producto()
    {
        ...
        try{
            conexion_bd = objeto_conexion.obtener();
            String strActualizar = "delete from tienda.producto  where id=?";
    ...
    public boolean ingresar_producto()
   {
    ...
    public ArrayList<Producto> getProductos(){
        ...
        try{
            conexion_bd = objeto_conexion.obtener();
            String strSentenciaSql = "SELECT id, nombre, valor FROM tienda.producto";
